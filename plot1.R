...
#plot data
hist(cons_power$Global_active_power,main = "Global Active Power",xlab = "Global Active Power(kilowatts)",col="red")
#Export data
dev.copy(png,filename="C:/Akash/Interests/Coursera/Data course/Exploratory Data analysis/Project 1/plot1.png", width = 480, height = 480);
dev.off ()
